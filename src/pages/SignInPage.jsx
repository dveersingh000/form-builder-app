...
import { google_icon } from "../data/fileImports";
    ...
    >
      ...
      >
        ...
        <div className={`flex flex-col ${styles.buttons}`}>
          ...
          <p className={`text-center ${styles.options}`}>OR</p>
          {/* Static Sign In with Google button */}
          <button type="button" className={`${styles.button} ${styles["google-button"]}`}>
            <div className={styles["google-btn-content"]}>
              <img src={google_icon} alt="Google" className={styles["google-icon"]} />
              <span>Sign in with Google</span>
            </div>
          </button>
          <p className={`text-center font-weight: 300`}>
